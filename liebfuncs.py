...
if __name__ == '__main__':
    ...
    compare_terms_pairs(dataset,
                        ...
                        maps=['pA', 'pAgF', 'pFgA', 'pAgF_given_pF=0.50', 'pFgA_given_pF=0.50', 'pAgF_z',
                              'pFgA_z', 'pAgF_z_FDR_0.01', 'pFgA_z_FDR_0.01'],
                        name='out',
                        even_studies=True,
                        sampling=100,
                        real_priors=False)
...
#                        maps=['pA', 'pAgF', 'pFgA', 'pAgF_given_pF=0.37', 'pFgA_given_pF=0.37', 'pAgF_z',
#                              'pFgA_z', 'pAgF_z_FDR_0.01', 'pFgA_z_FDR_0.01'],
#                        name='out')
