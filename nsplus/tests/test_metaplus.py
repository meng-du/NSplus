...
def test_init():
    ...
    assert_array_almost_equal(meta_list[1].images['association-test_z_FDR_0.01'], [16, 1.2, -8, -0.4, 0])
    assert_array_almost_equal(meta_list[2].images['uniformity-test_z'], [-48, -3.6, 24, 1.2, 0])
    assert_array_almost_equal(meta_list[3].images['pFgA_given_pF=0.50'], [16, 1.2, -8, -0.4, 0])
...
def test_winnings():
    ...
    assert_array_almost_equal(result.images['winnings'], [3, 2, 2, 1, 0])
    ...
    assert_array_almost_equal(result.images['winnings'], [1, 3, 1, 3, 5])
    ...
    assert_array_almost_equal(result.images['winnings'], [4, 3, 3, 4, 5])
