...
def quick_test():
    ...
    # for term in TERMS:
    #     print term
    #     analyze_expression(dataset, term, priors=[0.5])
    # print 'pairs'
...
if __name__ == '__main__':
    # TODO only need to mask when getting studies
    # quick_test()
    ...
    analysis_name = 'pairwise_conjunctions'
    print analysis_name
    # IMAGES = None
    ...
    for maskFile in maskFiles:
        ...
        # for term in TERMS:
        #     print term
        #     results.append(analyze_expression(dataset, term, priors=[0.5], image_names=SINGLE_IMGS))
